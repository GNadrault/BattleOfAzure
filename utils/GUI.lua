...
local function newElement(pX, pY)
  ...
  function myElement:setScale(pScaleX, pScaleY)
    self.ScaleX = pScaleX
    self.ScaleY = pScaleY
  end
  return myElement
...
function GUI.newText(pX, pY, pW, pH, pText, pFont, pHAlign, pVAlign, pColor)
  ...
  function myText:setText(pText)
    myText.Text = pText
  end
  
  function myText:setPosition(pX, pY)
    myText.X = pX
    myText.Y = pY
  end
  
  function myText:setColor(pColor)
    myText.Color = pColor
  end
...
function GUI.newButton(pX, pY, pW, pH, pText, pFont, pColor, pSize)
